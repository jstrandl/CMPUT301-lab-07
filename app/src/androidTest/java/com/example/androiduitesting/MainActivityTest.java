...
public class MainActivityTest {
    ...
    public void testShowActivityCityName() {
        ...
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list)).atPosition(0).check(matches((withText(cityName))));
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list)).atPosition(0).perform(click());
        onView(withId(R.id.city_name)).check(matches((withText(cityName))));
    }
